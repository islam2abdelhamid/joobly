    ...
    <div class="services">
        <div class="service">
            ...
            <div class="service-title">
                <a href="home_services/companies/homeCleaning">
        ...
        <div class="service">
            ...
            <div class="service-title">
                <a href="home_services/companies/babySitter">
        ...
        <div class="service">
            ...
            <div class="service-title">
                <a href="home_services/companies/elderlyHealthCare">
        ...
        <div class="service">
            ...
            <div class="service-title">
                <a href="home_services/companies/gardening">
        ...
        <div class="service">
            ...
            <div class="service-title">
                <a href="home_services/companies/other">
