...
<div class="signIn">
    <div class="container">
        ...
        <form class="form-group" action="/company/register" method="POST">
            ...
            <input type="text" class="form-control" name="managerName" placeholder={{ trans('company.managerName')}}>

            <label><i class="fas fa-star-of-life"></i>{{ trans('company.companyName')}}</label>
            <input type="text" class="form-control" name="companyName" placeholder={{ trans('company.companyName')}}>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="landTel" placeholder={{ trans('company.landTel')}}>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" placeholder={{ trans('company.address')}} name="address">
                </div>
            </div>
