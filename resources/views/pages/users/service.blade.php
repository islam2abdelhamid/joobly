    ...
    <div class="book-form mt-5">
        ...
        <div class="form-body">
            <form action="/services/book" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input class="form-control mt-2" type="text" name="name" placeholder="your name">
                    </div>
                    <div class="col-md-6">
                        <input class="form-control mt-2" type="text" name="address" placeholder="your address">
                    </div>
                    <div class="col-md-6">
                        <input class="form-control mt-2" type="text" name="mobile" placeholder="your mobile">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea id="my-textarea" class="form-control" name="description" rows="5" cols="100"></textarea>
                </div>
